  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imgerror="userImgerror" :src="userInfo.staffPhoto">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">你好，{{ userInfo.username }}，祝你开心每一天！</p>
            <p class="lastChild">你好，{{ userInfo.username }} | {{ userInfo.companyName }} | {{ userInfo.departmentName }}，祝你开心每一天！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
...
import userImgerror from '@/assets/common/lan.jpg'
